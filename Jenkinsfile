   ...
   stages {
       stage ('display env and checkout code'){
           ...
           parallel (
               ...
               'CheckOutCode':{
                   git branch: 'dev', credentialsId: 'githubcred', url: 'https://github.com/Kammula280/ecommercemavenweb.git'
       ...
       stage('Build docker image'){
           steps{
       sh "docker build -t kammula280/mavenwebapp:1 ."
           }
       }
       ...
       stage ('Push Docker Image to Repository'){
           steps{
               withCredentials([string(credentialsId: 'docker_hub_credentials', variable: 'docker_hub_credentials')]) {
                   ...
                   sh "docker push kammula280/mavenwebapp:1"
                   }
       }
       }
